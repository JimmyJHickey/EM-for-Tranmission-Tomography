...
# All the code you need in one place
# This will generate 3 circle plots with different radii
# and perform the EM algorithm on them, saving progress at
# each MC iteration.
...
for(radius in radius.seq){
  ...
  save(three_circles_results, file = "em_results/three_circles/three_circles_results.RData")
  print(three_circles_results)
  
}


save(seed_vec, file = "em_results/three_circles/seed_vec_three_circles_results.RData")
